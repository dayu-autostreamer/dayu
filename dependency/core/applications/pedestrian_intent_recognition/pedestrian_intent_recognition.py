    ...
    def __init__(self, trt_weights='', trt_plugin_library='', non_trt_weights='', device=0):
        ...
        if use_tensorrt:
            ...
            if jetpack_version == 6:
                ...
                from .pedestrian_intent_recognition_with_tensorrt import PedestrianIntentRecognitionTensorRT10
                self.model = PedestrianIntentRecognitionTensorRT10(
                ...
                from .pedestrian_intent_recognition_with_tensorrt import PedestrianIntentRecognitionTensorRT8
                self.model = PedestrianIntentRecognitionTensorRT8(
                    weights=self.trt_weights,
                    plugin_library=self.trt_plugin_library,
                    device=self.device,
                )
        else:
            from .pedestrian_intent_recognition_without_tensorrt import PedestrianIntentRecognitionWithoutTensorRT
            self.model = PedestrianIntentRecognitionWithoutTensorRT(weights=self.non_trt_weights, device=self.device)
