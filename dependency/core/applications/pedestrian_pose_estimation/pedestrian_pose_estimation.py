...
class PedestrianPoseEstimation:
    def __init__(self, trt_weights='', trt_plugin_library='', non_trt_weights='', device=0, non_trt_config=''):
        ...
        if use_tensorrt:
            ...
            if jetpack_version == 6:
                ...
                from .pedestrian_pose_estimation_with_tensorrt import PedestrianPoseEstimationTensorRT10
                self.model = PedestrianPoseEstimationTensorRT10(
                ...
                from .pedestrian_pose_estimation_with_tensorrt import PedestrianPoseEstimationTensorRT8
                self.model = PedestrianPoseEstimationTensorRT8(
                    weights=self.trt_weights,
                    plugin_library=self.trt_plugin_library,
                    device=self.device,
                )
        else:
            from .pedestrian_pose_estimation_without_tensorrt import PedestrianPoseEstimationWithoutTensorRT
            self.model = PedestrianPoseEstimationWithoutTensorRT(
