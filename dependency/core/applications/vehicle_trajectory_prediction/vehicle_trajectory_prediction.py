    ...
    def __init__(self, trt_weights='', trt_plugin_library='', non_trt_weights='', device=0):
        ...
        if use_tensorrt:
            ...
            if jetpack_version == 6:
                ...
                from .vehicle_trajectory_prediction_with_tensorrt import VehicleTrajectoryPredictionTensorRT10
                self.model = VehicleTrajectoryPredictionTensorRT10(
                ...
                from .vehicle_trajectory_prediction_with_tensorrt import VehicleTrajectoryPredictionTensorRT8
                self.model = VehicleTrajectoryPredictionTensorRT8(
                    weights=self.trt_weights,
                    plugin_library=self.trt_plugin_library,
                    device=self.device,
                )
        else:
            from .vehicle_trajectory_prediction_without_tensorrt import VehicleTrajectoryPredictionWithoutTensorRT
            self.model = VehicleTrajectoryPredictionWithoutTensorRT(weights=self.non_trt_weights, device=self.device)
