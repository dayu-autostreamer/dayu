...
class LicensePlateRecognition:
    def __init__(self, detect_weights: str, recognize_weights: str, device=0):
        self.detect_weights = Context.get_file_path(detect_weights)
        self.recognize_weights = Context.get_file_path(recognize_weights)
    ...
    def __call__(self, image: np.ndarray) -> List[Tuple[str, str]]:
        """
        端到端车牌识别流程
