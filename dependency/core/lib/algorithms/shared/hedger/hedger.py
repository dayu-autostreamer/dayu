...
class HedgerDeploymentCollectCfg:
    ...
    explore_unknown_prob: float = 0.65
    min_unknown_prior_quality: float = 0.30
    max_unknown_queue_pressure: float = 0.30
...
class HedgerDeploymentOfflineRLCfg:
    ...
    quality_margin_coef: float = 0.18
    ...
    replica_marginal_target_coef: float = 1.10
    replica_positive_margin_coef: float = 0.45
    ...
    coverage_logit_margin: float = 0.75
...
class Hedger:
    ...
    def _build_training_cfg(self, config: dict) -> HedgerTrainingCfg:
        ...
        deployment_collect = HedgerDeploymentCollectCfg(
            ...
            explore_unknown_prob=min(1.0, max(0.0, float(collect_cfg.get("explore_unknown_prob", 0.65)))),
            min_unknown_prior_quality=max(0.0, float(collect_cfg.get("min_unknown_prior_quality", 0.30))),
            max_unknown_queue_pressure=max(0.0, float(collect_cfg.get("max_unknown_queue_pressure", 0.30))),
        ...
        deployment_offline_rl = HedgerDeploymentOfflineRLCfg(
            ...
            device_count_over_budget_coef=max(
                0.0,
                float(offline_rl_cfg.get("device_count_over_budget_coef", 0.30)),
            ),
            alternative_option_margin_coef=max(
                0.0,
                float(offline_rl_cfg.get("alternative_option_margin_coef", 0.18)),
            ),
            ...
            positive_logit_margin=max(0.0, float(offline_rl_cfg.get("positive_logit_margin", 0.80))),
            ...
            alternative_option_logit_margin=max(
                0.0,
                float(offline_rl_cfg.get("alternative_option_logit_margin", 0.03)),
            ),
    ...
    def _ppo_update_fieldnames(include_offline_batch: bool = False) -> List[str]:
        fieldnames = [
            ...
            "device_concentration_loss", "device_count_over_budget_loss",
            "alternative_option_margin_loss", "projection_edge_coverage_loss",
            ...
            "actor_selected_non_soft_negative_weight_mean",
            ...
            "actor_unselected_negative_samples", "actor_selected_non_soft_negative_samples",
            ...
            "unselected_negative_logp_mean", "selected_non_soft_negative_logp_mean",
            "positive_prob_mean", "aux_positive_prob_mean",
            "negative_prob_mean", "raw_removed_prob_mean",
            "unselected_negative_prob_mean", "selected_non_soft_negative_prob_mean",
            "positive_logit_mean", "aux_positive_logit_mean",
            "negative_logit_mean", "raw_removed_logit_mean",
            "unselected_negative_logit_mean", "selected_non_soft_negative_logit_mean",
            ...
            "threshold_device_count_max", "threshold_device_count_over_budget_mean",
            "threshold_device_count_over_budget_count",
            "alternative_option_candidate_count_mean", "alternative_option_score_mean",
            ...
            "soft_target_trusted_count_mean", "soft_target_exploration_count_mean",
            "soft_target_untrusted_exploration_count_mean",
            "soft_target_known_prob_mean", "soft_target_untrusted_prob_mean",
            "soft_target_trusted_prob_mean", "soft_target_exploration_prob_mean",
            "soft_target_untrusted_exploration_prob_mean",
            "soft_target_exploration_floor_mean", "soft_target_risk_penalty_mean",
            "soft_target_untrusted_risk_penalty_mean",
            "prior_quality_mean", "trusted_quality_mean",
            ...
            "device_concentration_coef", "device_count_over_budget_coef",
            "alternative_option_margin_coef", "projection_edge_coverage_coef",
            ...
            "alternative_option_logit_margin",
    ...
    def _build_deployment_agent_params(self, agents_cfg: dict) -> dict:
        ...
        return {
            ...
            "trusted_runtime_confidence_threshold": _matrix_float(
    ...
    def _inference_deployment_fieldnames(self) -> List[str]:
        fieldnames = [
            ...
            "matrix_raw_selected_cnt", "matrix_selected_prob_mean",
            ...
            *Hedger._latency_guard_record_fieldnames(),
            ...
            "replica_negative_margin_coef", "option_slack_coef",
            "device_concentration_coef", "device_count_over_budget_coef",
            "alternative_option_margin_coef",
            "soft_target_bc_coef", "soft_target_negative_ceiling",
            "positive_logit_margin", "negative_logit_margin", "coverage_logit_margin",
            "ranking_logit_margin", "quality_order_logit_margin", "contrast_logit_margin",
            "alternative_option_logit_margin",
    ...
    def _deployment_decision_fieldnames(self) -> List[str]:
        fieldnames = [
            *Hedger._decision_common_fieldnames(),
            ...
            "collect_selected_prior_quality", "collect_selected_runtime_trusted",
            "collect_explore_unknown",
    ...
    def _log_deployment_decisions(
        ...
        for service_idx in range(raw_mask.size(0)):
            ...
            row = dict(
                ...
                collect_selected_prior_quality=collect_debug.get("collect_selected_prior_quality", ""),
                collect_selected_runtime_trusted=collect_debug.get("collect_selected_runtime_trusted", ""),
                collect_explore_unknown=collect_debug.get("collect_explore_unknown", ""),
            ...
            if self.record_cfg.decision_actor_debug:
                ...
                row.update({
                    ...
                    "deployment_matrix_raw_selected": self._json_for_record(
                        self._actor_debug_row_map(actor_debug, "matrix_raw_selected", service_idx)
                    ),
                    ...
                    "deployment_runtime_trusted": self._json_for_record(
                        self._actor_debug_row_map(actor_debug, "runtime_trusted", service_idx)
                    ),
                    ...
                    "deployment_soft_option_trusted_mask": self._json_for_record(
                        self._actor_debug_row_map(actor_debug, "soft_option_trusted_mask", service_idx)
                    ),
                    "deployment_soft_option_exploration_mask": self._json_for_record(
                        self._actor_debug_row_map(actor_debug, "soft_option_exploration_mask", service_idx)
                    ),
                    ...
                    "deployment_effective_option_floor": self._json_for_record(
                        self._actor_debug_vector_value(actor_debug, "effective_option_floor", service_idx)
                    ),
    ...
    def _try_deployment_collect_operation(
        ...
        prior_quality_matrix = self._deployment_collect_pair_prior_quality_matrix(
            logic_feats,
            phys_feats,
            static_allowed,
        )
        trusted_matrix = self._deployment_collect_runtime_trusted_matrix(
            logic_feats,
            static_allowed,
            base_mask.device,
        )
        ...
        device_counts = base_mask[:, :cloud_idx].float().sum(dim=0)
        max_edge_replicas = self.deployment_agent._max_edge_replicas_per_device()
        count_budget = float(max_edge_replicas) if max_edge_replicas else float(max(1, base_mask.size(0)))
        device_fill = (device_counts / max(count_budget, 1.0)).clamp(0.0, 2.0)

        candidates: List[Tuple] = []
        if operation == "safe_add":
            for service_idx in range(base_mask.size(0)):
                feasible_target = float(feasible_counts[service_idx].item())
                current_edges = float(edge_counts[service_idx].item())
                pressure = float(service_pressure[service_idx].item())
                desired_edges = 1.0 + pressure * max(0.0, feasible_target - 1.0)
                if current_edges + 0.25 >= min(feasible_target, desired_edges) or feasible_target <= 0.0:
                    continue
                if current_edges > 0.0 and pressure < 0.35:
                    continue
                for device_idx in range(cloud_idx):
                    if bool(base_mask[service_idx, device_idx].item()):
                        continue
                    observed_quality = float(quality_matrix[service_idx, device_idx].item())
                    prior_quality = float(prior_quality_matrix[service_idx, device_idx].item())
                    queue_pressure = float(pressure_matrix[service_idx, device_idx].item())
                    trusted = bool(trusted_matrix[service_idx, device_idx].item())
                    explore_unknown = (
                        not trusted
                        and prior_quality >= cfg.min_unknown_prior_quality
                        and queue_pressure <= cfg.max_unknown_queue_pressure
                    )
                    if not trusted and not explore_unknown:
                        continue
                    if not self._deployment_collect_pair_capacity_ok(
                        ...
                        continue
                    quality_for_score = observed_quality if trusted else prior_quality
                    exploration_bonus = (
                        0.35 * cfg.explore_unknown_prob
                        if explore_unknown and random.random() < cfg.explore_unknown_prob else 0.0
                    )
            ...
            return raw_mask, {
                ...
                "collect_removed_service_idx": -1,
                "collect_removed_device_idx": -1,
                "collect_selected_prior_quality": selected_prior_quality,
                "collect_selected_runtime_trusted": selected_trusted,
                "collect_explore_unknown": selected_explore_unknown,
            }
    ...
    def _deployment_collect_pair_prior_quality_matrix(
            self,
            logic_feats: Dict[str, torch.Tensor],
            phys_feats: Dict[str, torch.Tensor],
            static_allowed: torch.Tensor,
    ...
    def _deployment_collect_runtime_trusted_matrix(
            self,
            logic_feats: Dict[str, torch.Tensor],
            static_allowed: torch.Tensor,
            device: torch.device,
        ...
        num_services, num_devices = static_allowed.shape
        runtime_feat = logic_feats.get("runtime_pair_feat")
        trusted = torch.zeros((num_services, num_devices), dtype=torch.bool, device=device)
        if isinstance(runtime_feat, torch.Tensor) and runtime_feat.dim() == 3 and runtime_feat.size(-1) >= 5:
            runtime_feat = runtime_feat.to(device=device, dtype=torch.float32)
            confidence = runtime_feat[..., 3].clamp(0.0, 1.0) * runtime_feat[..., 4].clamp(0.0, 1.0)
            trusted = confidence >= float(self.deployment_agent_params.get(
                "trusted_runtime_confidence_threshold",
                0.25,
            ))
        return trusted & static_allowed.to(device=device).bool()
    ...
    def _deployment_collect_candidate_risk(
        ...
        def _plan_metrics(mask: torch.Tensor) -> Dict[str, Any]:
            ...
            prior_quality = option_ctx["prior_quality_score"].to(device=device).float()
            runtime_trusted = option_ctx["runtime_trusted"].to(device=device).float() >= 0.5
            ...
            edge_prior_quality = prior_quality[:, :cloud_idx] if cloud_idx > 0 else torch.zeros_like(masked_pressure)
            edge_runtime_trusted = runtime_trusted[:, :cloud_idx] if cloud_idx > 0 else torch.zeros_like(selected_edge)
            edge_exploration_quality = (
                (edge_prior_quality >= cfg.min_unknown_prior_quality)
                & (edge_pressure <= cfg.max_unknown_queue_pressure)
                & ~edge_runtime_trusted
            )
            edge_collect_quality = torch.where(
                edge_runtime_trusted | edge_exploration_quality,
                torch.maximum(edge_pair_quality, edge_prior_quality),
                edge_pair_quality,
            )
            ...
            selected_quality_values = edge_collect_quality.masked_select(selected_edge) if selected_edge.numel() \
                else torch.zeros((0,), device=device)
            ...
            return {
                ...
                "edge_pair_quality": edge_collect_quality,
            ...
            try:
                ...
                if self.dep_recorder is not None:
                    ...
                    row = dict(
                        ...
                        matrix_raw_selected_cnt=aux.get("matrix_raw_selected_cnt", 0),
                        matrix_selected_prob_mean=aux.get("matrix_selected_prob_mean", 0.0),
                        ...
                        expected_edge_count_mean=aux.get("expected_edge_count_mean", 0.0),
                        expected_edge_count_max=aux.get("expected_edge_count_max", 0.0),
                        expected_quality_mass_mean=aux.get("expected_quality_mass_mean", 0.0),
                        ...
                        threshold_device_count_max=aux.get("threshold_device_count_max", 0.0),
                        threshold_device_count_over_budget_mean=aux.get(
                            "threshold_device_count_over_budget_mean",
                            0.0,
                        ),
                        threshold_device_count_over_budget_count=aux.get(
                            "threshold_device_count_over_budget_count",
                            0.0,
                        ),
                        alternative_option_candidate_count_mean=aux.get(
                            "alternative_option_candidate_count_mean",
                            0.0,
                        ),
                        alternative_option_score_mean=aux.get("alternative_option_score_mean", 0.0),
                        alternative_option_above_threshold_ratio=aux.get(
                            "alternative_option_above_threshold_ratio",
                            0.0,
                        ),
                        ...
                        effective_option_logit_mean=aux.get("effective_option_logit_mean", 0.0),
                        non_top_logit_mean=aux.get("non_top_logit_mean", 0.0),
                        top_quality_logit_gap_mean=aux.get("top_quality_logit_gap_mean", 0.0),
                        effective_option_logit_gap_mean=aux.get("effective_option_logit_gap_mean", 0.0),
                        top_quality_candidate_count_mean=aux.get("top_quality_candidate_count_mean", 0.0),
                        effective_option_candidate_count_mean=aux.get("effective_option_candidate_count_mean", 0.0),
                        ...
                        soft_target_trusted_count_mean=aux.get("soft_target_trusted_count_mean", 0.0),
                        soft_target_exploration_count_mean=aux.get("soft_target_exploration_count_mean", 0.0),
                        soft_target_untrusted_exploration_count_mean=aux.get(
                            "soft_target_untrusted_exploration_count_mean", 0.0,
                        ),
                        ...
                        soft_target_trusted_prob_mean=aux.get("soft_target_trusted_prob_mean", 0.0),
                        soft_target_exploration_prob_mean=aux.get("soft_target_exploration_prob_mean", 0.0),
                        soft_target_untrusted_exploration_prob_mean=aux.get(
                            "soft_target_untrusted_exploration_prob_mean", 0.0,
                        ),
                        soft_target_exploration_floor_mean=aux.get("soft_target_exploration_floor_mean", 0.0),
                        soft_target_risk_penalty_mean=aux.get("soft_target_risk_penalty_mean", 0.0),
                        soft_target_untrusted_risk_penalty_mean=aux.get(
                            "soft_target_untrusted_risk_penalty_mean", 0.0,
                        ),
                        prior_quality_mean=aux.get("prior_quality_mean", 0.0),
                        trusted_quality_mean=aux.get("trusted_quality_mean", 0.0),
                        ...
                        **guard_record,
                        ...
                        device_count_over_budget_coef=offline_rl_record_cfg.device_count_over_budget_coef,
                        alternative_option_margin_coef=offline_rl_record_cfg.alternative_option_margin_coef,
                        ...
                        alternative_option_logit_margin=offline_rl_record_cfg.alternative_option_logit_margin,
    ...
    def train_deployment_agent(self):
        ...
        dep_train_fieldnames = ["step", "epoch", "decision_version", "dep_updates", "dep_reward",
                                ...
                                "selected_non_soft_positive_count_mean",
                                "selected_non_soft_positive_prob_mean", "selected_non_soft_positive_logit_mean",
                                "actor_selected_non_soft_negative_samples",
                                "selected_non_soft_negative_prob_mean",
                                "selected_non_soft_negative_logit_mean",
                                "selected_non_soft_negative_loss",
                                "non_effective_option_prob_mean",
                                "non_effective_selection_cost",
                                "top_quality_prob_mean", "non_top_prob_mean",
        ...
        while not self.deployment_thread_stop_event.is_set():
            try:
                ...
                tr = {
                    ...
                    "collect_selected_prior_quality": float(aux.get("collect_selected_prior_quality", 0.0)),
                    "collect_selected_runtime_trusted": int(aux.get("collect_selected_runtime_trusted", 0)),
                    "collect_explore_unknown": int(aux.get("collect_explore_unknown", 0)),
                ...
                row = dict(
                    ...
                    collect_selected_prior_quality=aux.get("collect_selected_prior_quality", ""),
                    collect_selected_runtime_trusted=aux.get("collect_selected_runtime_trusted", ""),
                    collect_explore_unknown=aux.get("collect_explore_unknown", ""),
                    ...
                    **state_record,
                    ...
                    device_count_over_budget_coef=(
                        self.training_cfg.deployment_offline_rl.device_count_over_budget_coef
                    ),
                    alternative_option_margin_coef=(
                        self.training_cfg.deployment_offline_rl.alternative_option_margin_coef
                    ),
                    ...
                    alternative_option_logit_margin=(
                        self.training_cfg.deployment_offline_rl.alternative_option_logit_margin
                    ),
    ...
    def _deployment_offline_update_kwargs(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "selected_non_soft_negative_coef": cfg.selected_non_soft_negative_coef,
            ...
            "alternative_option_logit_margin": cfg.alternative_option_logit_margin,
