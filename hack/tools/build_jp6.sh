...
declare -A DOCKERFILES=(
      ...
      [exposure-identification]="build/exposure_identification_jp6.Dockerfile"
      [category-identification]="build/category_identification_jp6.Dockerfile"
)
...
declare -A PLATFORMS=(
    ...
    [exposure-identification]="linux/arm64"
    [category-identification]="linux/arm64"
)
