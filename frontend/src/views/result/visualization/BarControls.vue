<template>
	<div class="bar-controls">
		<div class="variable-group">
			<span class="variable-title">Display Services:</span>
			<el-checkbox-group v-model="selectedVariables" @change="handleVariableChange">
				<el-checkbox v-for="varName in config.variables" :key="varName" :label="varName" class="variable-checkbox" />
			</el-checkbox-group>
		</div>
	</div>
</template>
...
export default {
	...
	setup(props, { emit }) {
		...
		selectedVariables.value = Object.keys(variableStates.value).filter((k) => variableStates.value[k]);
